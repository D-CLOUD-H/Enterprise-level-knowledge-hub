...
1. 用使用者自己的有效 embedding 与 Agent/Graph LLM key 启动 Compose。
2. 分别上传 `m5-nano-source.md`、`m5-traditional-source.md`、`m5-graph-source.md` 到内容指定的三条链路；每条链路都必须命中自己的唯一事实和对应 source。
